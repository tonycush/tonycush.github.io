        ...
        $('.turk_btn').on('click', function (e,data){
            ...
            var accs_table = new Tabulator("#temp_output", {
                ...
                columns:[
                    ...
                    { title: turk_data[solo_acc_loc]['current_year'], field: "cy_l", hozAlign: "right", formatter: "money", formatterParams: {
                        symbol: "£",
                        precision: 0,
                    } },
                    { title: turk_data[solo_acc_loc]['current_year'], field: "cy_r", hozAlign: "right", formatter: "money", formatterParams: {
                        symbol: "£",
                        precision: 0,
                    } },
                    { title: turk_data[solo_acc_loc]['previous_year'], field: "py_l", hozAlign: "right", formatter: "money", formatterParams: {
                        symbol: "£",
                        precision: 0,
                    } },
                    {
                        title: turk_data[solo_acc_loc]['previous_year'], field: "py_r", hozAlign: "right", formatter: "money", formatterParams: {
                            symbol: "£",
                            precision: 0,
                        }
                    },                
